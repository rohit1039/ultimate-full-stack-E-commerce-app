...
/**
 * This class will format our JSON response in such a way that the hasChildren field in
 * both Category and in CategoryResponseDTO class will be excluded if value is false.
 * <p>
