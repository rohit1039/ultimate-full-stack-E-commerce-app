...
public class CategoryModelAssembler
	...
	@Override
	@NonNull
	public EntityModel<CategoryResponseDTO> toModel(@NonNull CategoryResponseDTO categoryResponseDTO) {

		return EntityModel.of(categoryResponseDTO,
				linkTo(methodOn(CategoryServiceController.class).getCategoryById(categoryResponseDTO.getCategoryId()))
					.withSelfRel());
	}
