...
public interface CategoryService {
  ...
  CategoryResponseDTO saveCategory(CategoryRequestDTO categoryDTO, String username, String role)
      throws Exception;
  ...
  CategoryResponseDTO updateCategory(
      Long categoryId, CategoryRequestDTO categoryRequestDTO, String username, String role)
      throws Exception;

  void updateStatusCategory(Long categoryId, boolean status, String username, String role)
      throws Exception;
}
