...
import static com.ecommerce.payment.constants.Constant.API_GATEWAY_SERVER_URL;
import static com.ecommerce.payment.constants.Constant.PAYMENT_SERVICE_SERVER_URL;
...
public class SwaggerConfig {
  ...
  public OpenAPI springOpenAPI() {
    ...
    return new OpenAPI()
        ...
        .info(
            new Info()
                .title("Payment Service - Ultimate E-commerce Application")
                .description(
        ...
        .addServersItem(
            new Server().url(PAYMENT_SERVICE_SERVER_URL).description("Generated server url"));
  }
}
