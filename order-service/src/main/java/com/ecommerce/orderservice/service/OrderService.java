...
public interface OrderService {
  ...
  void saveOrder(MongoClient mongoClient, JsonObject requestBody, String username,
  ...
  void updateOrderStats(MongoClient mongoClient, String orderId, String paymentStatus,
