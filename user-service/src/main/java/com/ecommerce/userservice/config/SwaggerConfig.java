...
public class SwaggerConfig {
  ...
  /**
   * This method creates a new instance of the OpenAPI object, which is used to define the swagger
   * documentation.
   *
  ...
  public OpenAPI springOpenAPI() {
    ...
    return new OpenAPI()
        ...
        .info(
            new Info()
                .title("User Service - Ultimate E-commerce Application")
                .description(
        ...
        .addServersItem(
            new Server().url(USER_SERVICE_SERVER_URL).description("Generated server url"));
  }
}
