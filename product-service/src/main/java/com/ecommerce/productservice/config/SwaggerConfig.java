...
public class SwaggerConfig {
	...
	/**
	 * This method creates an instance of the OpenAPI class, which is a model that
	 * represents an OpenAPI document. The components section of the OpenAPI object
	 * contains a list of components used by the API, including security schemes. The
	 * security section of the OpenAPI object contains a list of security requirements,
	 * which are a list of security schemes that apply to a specific API operation. The
	 * info section of the OpenAPI object contains metadata about the API, including the
	 * title, description, version, and license. The externalDocs section of the OpenAPI
	...
	public OpenAPI springOpenAPI() {
		...
		return new OpenAPI()
			...
			.info(new Info().title("Product Service - Ultimate E-commerce Application")
				.description(
						"This service is developed by Rohit Parida, managed by admins and consumed by the clients. "
								+ "This service is running on port 8083.")
				.version("v1.0.0")
			...
			.addServersItem(new Server().url(PRODUCT_SERVICE_SERVER_URL).description("Generated server url"));
	}
