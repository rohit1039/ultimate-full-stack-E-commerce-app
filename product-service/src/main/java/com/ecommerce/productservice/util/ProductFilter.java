...
/**
 * This class will format our JSON response in such a way that the boolean field in both Product and
 * in ProductResponseDTO class will be excluded if value is false.
 *
